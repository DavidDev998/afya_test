  ...
  getCoinDetails: async (
    ...
    const coinDetails: CoinDetails = {
      ...
      fully_diluted_valuation:
        data.market_data?.fully_diluted_valuation?.[currency] || 0,
      ...
      price_change_24h:
        data.market_data?.price_change_24h_in_currency?.[currency] || 0,
      price_change_percentage_24h:
        data.market_data?.price_change_percentage_24h_in_currency?.[currency] ||
        0,
      market_cap_change_24h:
        data.market_data?.market_cap_change_24h_in_currency?.[currency] || 0,
      ...
      ath_change_percentage:
        data.market_data?.ath_change_percentage?.[currency] || 0,
      ath_date: data.market_data?.ath_date?.[currency] || '',
      atl: data.market_data?.atl?.[currency] || 0,
      atl_change_percentage:
        data.market_data?.atl_change_percentage?.[currency] || 0,
